...
static void cs47l35_hp_post_enable(struct snd_soc_dapm_widget *w)
{
	...
	case MADERA_OUT1R_ENA_SHIFT:
		val = snd_soc_component_read32(component, MADERA_OUTPUT_ENABLES_1);
...
static int cs47l35_set_fll(struct snd_soc_component *component, int fll_id, int source,
...
static int cs47l35_component_probe(struct snd_soc_component *component)
{
	...
	ret = madera_init_spk(component, 1);
	if (ret)
		return ret;
...
static struct snd_soc_component_driver soc_component_dev_cs47l35 = {
...
static int cs47l35_probe(struct platform_device *pdev)
{
	...
	ret = devm_snd_soc_register_component(&pdev->dev, &soc_component_dev_cs47l35,
